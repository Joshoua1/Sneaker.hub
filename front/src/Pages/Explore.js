...
function Explore() {
  ...
  return (
    <div className="font-sans bg-gray-50">
      {/* Navbar */}
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-black bg-opacity-90 py-3' : 'bg-transparent py-5'}`}>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-black bg-opacity-90 py-4">
            <div className="px-4 space-y-4">
              <Link to="/Landing" className="block text-white hover:text-red-400 transition duration-300">Home</Link>
              <Link to="/products" className="block text-white hover:text-red-400 transition duration-300">Products</Link>
              <Link to="/about" className="block text-white hover:text-red-400 transition duration-300">About</Link>
              <Link to="/contact" className="block text-white hover:text-red-400 transition duration-300">Contact</Link>
              ...
              {user ? (
                ...
                <div className="pt-4 border-t border-gray-700 space-y-2">
                  <Link 
                    to="/login" 
                    className="block text-white hover:text-red-400 transition duration-300"
                  >
                    Login
                  </Link>
                  <Link 
                    to="/signup" 
                    className="block bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-md transition duration-300 text-center"
                  >
                    Sign Up
                  </Link>
                </div>
